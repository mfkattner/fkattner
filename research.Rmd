...
More recently, I have been studying the influence of auditory distractor stimuli on attention in dual-task situations. Specifically, using an auditory search task in the "psychological refractory period" paradigm, we were able to show that auditory and central attention do not depend on the same central capacity limitations (Kattner & Reimer, 2020, _QJEP_). 

#### **Participate**

Click here to participate in a current study on verbal short-term memory in [English](https://www.psytoolkit.org/c/3.1.0/survey?s=Jyv8q) or [German](https://www.psytoolkit.org/c/3.1.0/survey?s=5WN2M).

Click here to participate in a current study using the "auditory" search task in [English](https://www.psytoolkit.org/c/3.1.1/survey?s=DGZSN) or [German](https://www.psytoolkit.org/c/3.1.1/survey?s=Bzj4f).
...
[Click here to participate in  current study on category learning (in English).](https://www.psytoolkit.org/c/3.3.0/survey?s=U9JpZ)
